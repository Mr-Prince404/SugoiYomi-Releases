...
>
  ...
  <defs>
    <linearGradient id="background" x1="0" y1="0" x2="1" y2="1">
      ...
      <stop offset="45%" stop-color="#100b18"/>
      <stop offset="100%" stop-color="#080a0f"/>
    </linearGradient>

    <radialGradient id="centerGlow" cx="50%" cy="44%" r="50%">
      <stop offset="0%" stop-color="#a855f7" stop-opacity="0.20"/>
      <stop offset="42%" stop-color="#7c3aed" stop-opacity="0.08"/>
    ...
    <linearGradient id="androidBorder" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="#3DDC84" stop-opacity="0.60"/>
      <stop offset="100%" stop-color="#a855f7" stop-opacity="0.22"/>
    </linearGradient>

    <linearGradient id="iosBorder" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="#ffffff" stop-opacity="0.55"/>
      <stop offset="100%" stop-color="#a855f7" stop-opacity="0.28"/>
    </linearGradient>

    <filter id="phoneShadow" x="-30%" y="-30%" width="160%" height="180%">
      <feDropShadow
        dx="0"
        dy="24"
        stdDeviation="22"
    ...
    <clipPath id="androidClip">
      <rect x="138" y="90" width="334" height="724" rx="38"/>
    </clipPath>

    <clipPath id="iosClip">
      <rect x="1128" y="90" width="334" height="724" rx="38"/>
    </clipPath>
  </defs>
  ...
  <g>
    ...
    <circle cx="238" cy="869" r="5" fill="#3DDC84"/>
  ...
  <g>
    ...
    <circle cx="1228" cy="869" r="5" fill="#d8b4fe"/>
