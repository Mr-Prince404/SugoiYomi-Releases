...
La versión móvil no busca ser simplemente una adaptación de la interfaz de escritorio. Está siendo desarrollada como una experiencia pensada específicamente para dispositivos móviles, conservando las ideas principales de SugoiYomi mientras se adaptan la navegación, el lector, las descargas y la gestión de biblioteca al uso táctil.
...
Las fuentes, catálogos y servicios externos utilizados mediante la aplicación son independientes de SugoiYomi y su disponibilidad puede cambiar con el tiempo.
